        ...
        <div className="testi-layout fade">
          ...
          <div className="testi-item">
            ...
            <div className="testi-author">
              ...
              <div><div className="testi-name">Siddharth K.</div><div className="testi-role">Research Intern, CSIR-NIO</div></div>
            </div>
          </div>
          <div className="testi-item">
            ...
            <div className="testi-author">
              ...
              <div><div className="testi-name">Preethi M.</div><div className="testi-role">1st Year, NIT Surathkal</div></div>
            </div>
          </div>
        </div>
      </div>
